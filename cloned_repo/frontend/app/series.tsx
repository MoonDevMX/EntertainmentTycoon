import { View, Text, ScrollView, TouchableOpacity, StyleSheet, Modal, TextInput, SafeAreaView } from 'react-native';
  ...
  return (
    <View style={{ flex: 1, backgroundColor: T.bg }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 12, paddingBottom: 100 }}>
        <TouchableOpacity style={s.bigBtn} onPress={() => router.push('/create-series')} testID="series-new-btn">
