...
type Ctx = {
  ...
  // V35 — Channel Packs
  createChannelPack: (args: { name: string; channelIds: string[]; monthlyFeeUSD: number }) => { error?: string; packId?: string };
...
export function GameProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <GameCtx.Provider value={{
      ...
      quoteWholeNetworkLicense: (s, args) => qWNL(s, args),
